 ...
 * @since 2.0
 */
public class LocalVariableTableParameterNameDiscoverer1 implements ParameterNameDiscoverer {

	private static final Log logger = LogFactory.getLog(LocalVariableTableParameterNameDiscoverer1.class);
